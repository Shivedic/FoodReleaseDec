package com.shivedic.foodveda.Volley;
...
import com.shivedic.foodveda.Activities.EditCart;
import com.shivedic.foodveda.Activities.ForgotPassword;
import com.shivedic.foodveda.Activities.Login;
import com.shivedic.foodveda.Activities.MainActivity;
import com.shivedic.foodveda.Activities.ProductExtra;
...
import com.shivedic.foodveda.Fragments.FAQ;
import com.shivedic.foodveda.Fragments.FavoriteList;
import com.shivedic.foodveda.Fragments.MainFragment;
import com.shivedic.foodveda.Fragments.MyCartList;
import com.shivedic.foodveda.Fragments.MyOrders;
import com.shivedic.foodveda.Fragments.MyProfile;
import com.shivedic.foodveda.Fragments.ProductDetail;
import com.shivedic.foodveda.Fragments.TermsAndConditions;
...
public class Volley_Request {
    ...
    public static void createRequest(final Context mContext, String requestURI, String type, String returnPath, final String requestBody) {
            ...
            */
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, requestURI, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (returnPathCopy == "getCatList")
                    ...
                    else if (returnPathCopy == "getRestaurantDetailOrder")
                        Config.resDetailResponse(response);
                        ...
                        Config.addOrederResponse(response);
                    else if (returnPathCopy == "login")
                        Login.loginResponse(response);
                    else if (returnPathCopy == "resentemail")
                        AccountVerification.resentEmailResponse(response);
