...
import com.shivedic.foodveda.Adapter.RecommendedExtrasAdapter;
...
static SweetAlertDialog pDialog = null;
    ...
    private void addToCart() {
        ...
        pDialog = new SweetAlertDialog(ProductExtra.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        String req = "{\"res_id\":\"" + SplashScreen.resId + "\",\"product_id\":\""+ product.getProductId() +"\",\"userid\":\"" + MainActivity.userId + "\",\"varient_id\":\""+ variantId +"\",\"varient_quantity\":\""+ quantity + "" +"\",\"json_param\":"+ extraJsonArray.toString() +",\"varient_name\":\""+ variantName +"\",\"varient_price\":\"" + variantPrice + "\",\"product_name\":\""+product.getProductName() +"\"}";
