...
public class SignUp extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        pDialog.show();
        String req = "{\"res_id\":\"" + SplashScreen.resId + "\",\"name\":\""+ editTexts.get(0).getText().toString().trim() +"\",\"email\":\""+ email.getText().toString().trim() +"\",\"password\":\"" +editTexts.get(1).getText().toString().trim() + "\",\"logintype\":\""+ "email" +"\"}";
