...
import com.shivedic.foodveda.Adapter.EditExtrasAdapter;
...
public class EditCart extends AppCompatActivity {
    ...
    private void addToCart() {
        ...
        pDialog = new SweetAlertDialog(EditCart.this, SweetAlertDialog.PROGRESS_TYPE);
        pDialog.getProgressHelper().setBarColor(getResources().getColor(R.color.colorPrimary));
        pDialog.setTitleText("Loading");
        pDialog.setCancelable(false);
        pDialog.show();

        String request = "{\"res_id\":\"" + SplashScreen.resId + "\",\"product_id\":\""+ product.getProductId() +"\",\"userid\":\"" + MainActivity.userId + "\",\"varient_id\":\""+ variantId +"\",\"varient_quantity\":\""+ quantity + "" +"\",\"json_param\":\""+ extraJsonArray.toString() +"\",\"varient_name\":\""+ variantName +"\",\"varient_price\":\"" + variantPrice + "\",\"product_name\":\""+product.getProductName() +"\"}";
        Volley_Request postRequest = new Volley_Request();
        postRequest.createRequest(EditCart.this, getResources().getString(R.string.mJSONURL_addcart), "POST", "addcartEdit", request);
        /*
        /*
