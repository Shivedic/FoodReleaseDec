...
public class Login extends AppCompatActivity {
    ...
    private void login() {
        ...
        String req = "{\"res_id\":\"" + SplashScreen.resId + "\",\"email\":\""+email.getText().toString().trim()+"\",\"password\":\""+ password.getText().toString().trim()+"\",\"logintype\":\""+ "email" +"\"}";
    ...
    public static void loginResponse(String response){
        try {
            pDialog.dismiss();
            String responseTrim = response.substring(response.indexOf("success") - 2);
            Log.d("myTag", "response Trim : " + responseTrim);
            JSONObject jObj = new JSONObject(responseTrim);
            Log.d("signUpResponse", jObj.getString("userid") + "");
