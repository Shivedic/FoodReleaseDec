...
import com.shivedic.foodveda.Adapter.ProductsByCategoryAdapter;
...
public class MainFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (viewPagerCurrentPos == 0 ) {
            ...
            Log.d("myTag", "recom size  : " +SplashScreen.recommendedProductList.size() );
        ...
        Log.d("myTag", "tab count : " +  simpleTabLayout.getTabCount());
        if(simpleTabLayout.getTabCount() == 0) {
