...
import com.shivedic.foodveda.Adapter.DetailPageSliderPagerAdapter;
import com.shivedic.foodveda.Adapter.DetailPageVariantAdapter;
import com.shivedic.foodveda.Adapter.DotsAdapter;
import com.shivedic.foodveda.Adapter.MyPagerAdapter;
import com.shivedic.foodveda.Extras.Config;
import com.shivedic.foodveda.FCM.MyFirebaseInstanceIDService;
import com.shivedic.foodveda.MVP.AddToWishlistResponse;
...
static SweetAlertDialog pDialog = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dots = (RecyclerView) view.findViewById(R.id.dotsRecyclerView);
        variant = (RecyclerView) view.findViewById(R.id.variantRecyclerView);
        cd = (CardView) view.findViewById(R.id.variantCardView);
        im = (ImageView) view.findViewById(R.id.noImageAdded);
        web = (WebView) view.findViewById(R.id.productDescWebView);
    ...
    private void addToWishList() {
        ...
        pDialog.show();
        String req = "{\"res_id\":\"" + SplashScreen.resId + "\", \"product_id\":\""+ productList.get(position).getProductId() + "\"}";
    ...
    private static void checkWishList() {
        ...
        String req = "{\"res_id\":\"" + SplashScreen.resId + "\", \"product_id\":\""+ productList.get(position).getProductId() + "\",\"user_id\":\"" + MainActivity.userId + "\"}";
        Volley_Request postRequest = new Volley_Request();
    ...
    private void setData() {
        ...
        try {
            ...
            Log.d("myTag", "error productdetails : " , e);
            //im.setVisibility(View.VISIBLE);
        }
        setDots(0);
