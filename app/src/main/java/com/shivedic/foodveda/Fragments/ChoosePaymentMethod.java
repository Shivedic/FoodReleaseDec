...
import com.shivedic.foodveda.PaymentIntegrationMethods.RazorPayIntegration;
        ...
        switch (view.getId()) {
            ...
            case R.id.makePayment:
                if (!check.isChecked()) {
                    ...
                    Log.d("myTag", "rest pins : " + SplashScreen.restaurantDetailResponseData.getDeliverycity().toString() + " : " + profilePinCode);
