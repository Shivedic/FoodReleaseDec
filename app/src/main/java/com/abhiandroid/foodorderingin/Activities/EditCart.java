...
public class EditCart extends AppCompatActivity {
    ...
    private void addToCart() {
        ...
        String request = "{\"res_id\":\"res007\",\"product_id\":\""+ product.getProductId() +"\",\"userid\":\"" + MainActivity.userId + "\",\"varient_id\":\""+ variantId +"\",\"varient_quantity\":\""+ quantity + "" +"\",\"json_param\":\""+ extraJsonArray.toString() +"\",\"varient_name\":\""+ variantName +"\",\"varient_price\":\"" + variantPrice + "\",\"product_name\":\""+product.getProductName() +"\"}";
