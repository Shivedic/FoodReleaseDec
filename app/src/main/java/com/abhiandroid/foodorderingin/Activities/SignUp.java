...
public class SignUp extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        pDialog.show();
        String req = "{\"res_id\":\"res007\",\"name\":\""+ editTexts.get(0).getText().toString().trim() +"\",\"email\":\""+ email.getText().toString().trim() +"\",\"password\":\"" +editTexts.get(1).getText().toString().trim() + "\",\"logintype\":\""+ "email" +"\"}";
